            ...
            <div className="col-span-12 lg:col-span-4 formItem">
              ...
              {typePropertyValue === "project" ? (
                <Popover>
                  ...
                  >
                    <button className="bg-white outline-none text-start flex justify-between items-center">
                      <span>
                        {typeValue.length === 0
                          ? t("properties.crudProperty.type")
                          : t("properties.crudProperty.typeSelected")}
                      </span>
                      <span>
                        <MdOutlineKeyboardArrowDown
                  ...
                  <PopoverContent
                    align="start"
                    className="h-[200px] bg-white w-[250px]"
                  >
                    <div className="flex flex-col justify-start items-start gap-y-4 h-full w-full overflow-y-scroll scrollbar-custom">
                      {types.map((type) => {
                        return (
                          <label
                            key={type.id}
                            htmlFor={`typeItem-${type.id}`}
                            className="p-2 hover:bg-blue-600 transition-all cursor-pointer hover:text-white flex justify-start items-center gap-x-2 w-full"
                          >
                            <input
                              onChange={(e) => {
                                setTypeValue((prev) =>
            ...
            <div className="col-span-12 lg:col-span-4 formItem">
              ...
              <div className="w-full relative">
                ...
                <div className="absolute top-10 -right-5 translate-x-[-50%] translate-y-[-50%] flex justify-end items-center gap-x-1">
                  ...
                  <div className="flex justify-center items-center">
                    <label className="flex justify-end items-center gap-x-1">
                      <input type="radio" value="km" {...register("seaType")} />
                      <span>KM</span>
                    </label>
                  </div>
                </div>
