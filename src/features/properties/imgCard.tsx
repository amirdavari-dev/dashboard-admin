...
const ImageCard = ({
  ...
  return (
    <div className="group w-[140px] min-w-[140px] max-w-[140px] h-[80px] rounded-[40px] overflow-hidden relative">
      <img src={src} className="w-full h-full" alt="" />
      <div className="hidden group-hover:flex justify-center items-center gap-x-2  absolute top-0 left-0 w-full h-full ">
        <motion.button
          whileHover={{ scale: 1 }}
          whileTap={{ scale: 0.95 }}
          initial={{ scale: 0 }}
